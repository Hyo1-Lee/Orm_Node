...
router.get("/list", isLoggedin_pass, async (req, res, next) => {
...
router.post("/create", isLoggedin_pass, async (req, res) => {
...
// 목록페이지 이동처리
router.post("/modify/:id", isLoggedin_pass, async (req, res) => {
...
// 목록페이지 이동처리
router.get("/delete/:aid", isLoggedin_pass, async (req, res) => {
